                ...
                {items.map((item, idx) => (
                    ...
                    >
                        <blockquote className="flex flex-col flex-1 justify-between h-full">
                            <span className="relative z-20 flex-1 md:text-lg text-sm leading-[1.6] font-normal text-neutral-800 dark:text-gray-100">
                                {item.quote}
                            </span>
                            ...
                            <div className="relative z-20 mt-6 flex flex-row items-center">
                                ...
                                <span className="flex flex-col gap-1">
                                    <span className="text-xl leading-[1.6] font-bold text-black dark:text-gray-200">
                                        {item.name}
                                    </span>
